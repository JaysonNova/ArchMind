<template>
  <div ref="containerRef" :class="['aurora-wrapper', className]" :style="style">
    <div v-if="!isReady" class="aurora-placeholder"></div>
  </div>
</template>

<script setup lang="ts">
import { onMounted, onUnmounted, watch, ref, type CSSProperties, useTemplateRef } from 'vue';
...
const initAurora = () => {
  ...
  gl.canvas.style.transition = 'opacity 0.3s ease';
